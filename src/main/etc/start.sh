...
java $DEBUG -Xms256m -Xmx1024m -Dserver.address=$HOST -Dserver.port=$PORT -Dlogging.level.org.springframework.web=ERROR -Dlogging.level.il.co.topq.report=$LOGGING_LEVEL -cp "lib/kpi-editor.jar:plugin/*" org.springframework.boot.loader.JarLauncher
